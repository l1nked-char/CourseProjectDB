...
public class TableConfig {
    ...
    public TableConfig(String tableName,
        ...
        this(tableName, dataLoader, onAdd, onEdit, onRefresh, null, columns, filters, null, false);
    }
    ...
    public TableConfig(String tableName,
        ...
        this(tableName, dataLoader, onAdd, onEdit, onRefresh, null, columns, filters, onToggleActive, false);
    }
    ...
    public TableConfig(String tableName,
                       ...
                       List<ColumnConfig> columns,
                       List<FilterConfig> filters) {
        this(tableName, dataLoader, onAdd, onEdit, onRefresh, onBooking, columns, filters, null, false);
    }
    public TableConfig(String tableName,
                       Function<Map<String, Object>, ObservableList<Object>> dataLoader,
                       Callback<Void, Void> onAdd,
                       ...
                       List<FilterConfig> filters,
                       Callback<Object, Void> onToggleActive) {
        this(tableName, dataLoader, onAdd, onEdit, onRefresh, onBooking, columns, filters, onToggleActive, false);
    }
